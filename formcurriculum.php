				...
				<div class="section group">
					...
					<div class="col span_2_of_3">
						<div class="contact-form">
							...
							<form method="post" name="formcurriculum"
								onsubmit="return validaCampos();" action="gerarpdf.php">
								<div>
								...
								<div>
									<span><label>Nacionalidade</label> </span> <span><input
										name="nacionalidade" type="text" class="textbox"> </span>
								</div>
								<div>
								...
								<div>
									<span><label>E-mail</label> </span> <span><input name="email"
										type="email" class="textbox"> </span>
								</div>
								<div>
									<span><label>Objetivo</label> </span> <span><input
										name="objetivo" type="text" class="textbox"> </span>
								</div>
								<div>
									<span><label>curso</label> </span> <span><input name="curso"
										type="text" class="textbox"> </span>
								</div>
								<div>
								...
								<div>
									<span><label>Ano de conclusão</label> </span> <span><input
										name="ano" type="text" class="textbox"> </span>
								</div>
								<div>
									<span><label>Empresa</label> </span> <span><input
										name="empresa" type="text" class="textbox"> </span>
								</div>
								<div id="atividade">
									<span><label>Atividades Complementares</label> </span> <span><input
										name='ativ[]' type='text' class='textbox'> </span>
								</div>
								<span id="addAtv">+ Atividades</span>
								<div id="infor">
									<span><label>Informações Complementares</label> </span> <span><input
										name="info[]" type="text" class="textbox"> </span>
								</div>
								<span id="addInfo">+ Informações</span>
								<div>
